...
export class createAddressLink1667583246867 implements MigrationInterface {
    name = 'createAddressLink1667583246867'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "rooms" ("id" SERIAL NOT NULL, "capacity" integer, CONSTRAINT "PK_0368a2d7c215f2d0458a54933f2" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "tickets" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "price" integer NOT NULL DEFAULT '15', "chair" integer, "userId" uuid, "sessionId" integer, CONSTRAINT "REL_d175b024857bfa9676f6a06368" UNIQUE ("sessionId"), CONSTRAINT "PK_343bc942ae261cf7a1377f48fd0" PRIMARY KEY ("id"))`);
