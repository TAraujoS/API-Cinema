...
export class createTables1667403432544 implements MigrationInterface {
    name = 'createTables1667403432544'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sessions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "day" date NOT NULL DEFAULT now(), "hour" TIME NOT NULL DEFAULT now(), "roomId" uuid, "movieId" uuid, CONSTRAINT "PK_3238ef96f18b355b671619111bc" PRIMARY KEY ("id"))`);
